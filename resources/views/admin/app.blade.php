				...
				<ul class="nav navbar-nav">
					@if (Auth::check())
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="{{ url('/home/galleries') }}"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span> Showcase</a></li>
								<li><a href="{{ url('/home/galleryrankings') }}"><span class="glyphicon glyphicon-star" aria-hidden="true"></span> Showcase Ranking</a></li>
								<li class="divider"></li>
								<li><a href="{{ url('/home/imagelabels') }}"><span class="glyphicon glyphicon-tag" aria-hidden="true"></span> Showcase Labels</a></li>
							</ul>
						</li>
						<li class="dropdown">
