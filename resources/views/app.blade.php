...
<head>
	...
	@yield('meta')
	@yield('head')
	<link rel="icon" href="{{ asset('/img/favicon.ico') }}?v=2">
	...
	<![endif]-->
	<script src='https://embed.tawk.to/55f644695cc4b66b4008cc99/default' charset="UTF-8" crossorigin="*"></script>
	<script type="text/javascript" src="https://www.gstatic.com/recaptcha/api2/r20170109113303/recaptcha__en.js"></script>
